...
{
	SpriteInfo drawers[] = {
		{ IMID_PLAYER		   , 0, "digg1.tga"},
		{ IMID_PLAYER		   , 1, "digg2.tga"},
		{ IMID_PLAYER		   , 2, "digg3.tga" },
		{ IMID_PLAYER		   , 3, "digg4.tga"},
		{ IMID_PROTESTER, 0, "protester1.tga"},
		{ IMID_PROTESTER, 1, "protester2.tga" },
		{ IMID_PROTESTER, 2, "protester3.tga" },
		{ IMID_HARD_CORE_PROTESTER, 0, "hardcore1.tga" },
		{ IMID_HARD_CORE_PROTESTER, 1, "hardcore2.tga" },
		{ IMID_HARD_CORE_PROTESTER, 2, "hardcore3.tga" },
		{ IMID_HARD_CORE_PROTESTER, 3, "hardcore4.tga" },
		{ IMID_WATER_SPURT, 0, "water1.tga" },
		{ IMID_WATER_SPURT, 1, "water2.tga" },
		{ IMID_WATER_SPURT, 2, "water3.tga" },
		{ IMID_BARREL , 0, "barrel.tga"},
		{ IMID_GOLD, 0, "gold.tga" },
		{ IMID_SONAR, 0, "sonar.tga" },
		{ IMID_WATER_POOL , 0, "waterpool.tga" },
		{ IMID_DIRT, 0, "dirt.tga" },
		{ IMID_BOULDER, 0, "rock1.tga" },
		{ IMID_BOULDER, 1, "rock2.tga" },
		{ IMID_BOULDER, 2, "rock3.tga" },
		{ IMID_BOULDER, 3, "rock4.tga" },
	};

	SoundMapType::value_type sounds[] = {
		make_pair(SOUND_THEME					, "imperial_march.wav"),
		make_pair(SOUND_PROTESTER_YELL		   , "whatareyoudoing.wav"),
		make_pair(SOUND_PROTESTER_GIVE_UP		, "giveup.wav"),
		make_pair(SOUND_PLAYER_SQUIRT			, "blaster-firing.wav"),
		make_pair(SOUND_PLAYER_GIVE_UP			   , "doh_reverb.wav"),
		make_pair(SOUND_PLAYER_ANNOYED			,	"goaway.wav"),
		...
		make_pair(SOUND_PLAYER_DIE				,"too-da-loo-mother-f-er.wav")	
	};
...
void GameController::doSomething()
{
	switch (m_gameState)
	{
		...
		case welcome:
			...
			m_mainMessage = "Welcome to SpaceMan!";
