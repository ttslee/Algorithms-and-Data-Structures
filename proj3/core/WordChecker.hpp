...
private:
    ...
    void swapAdjacent(const std::string& word, std::vector<std::string>& suggestions) const;
    void insertChar(const std::string& word, std::vector<std::string>& suggestions) const;
    void deleteChar(const std::string& word, std::vector<std::string>& suggestions) const;
    void replaceChar(const std::string& word, std::vector<std::string>& suggestions) const;
    void spaceBetween(const std::string& word, std::vector<std::string>& suggestions) const;
